...
@section('content')
                                                                ...
                                                                <li>
                                                                    ...
                                                                    @if ($usr->status == 'active')
                                                                        <a class="dropdown-item"
                                                                            href="{{ route('superadmin.suspendUser', [$usr->id]) }}"  onclick="return confirm('Are you sure you want to suspend this user account');"><i
                                                                                class="fe fe-trash dropdown-item-icon"
                                                                               ></i>Suspend
                                                                            User</a>
                                                                    @else
                                                                        <a class="dropdown-item"
                                                                            href="{{ route('superadmin.activateUser', [$usr->id]) }}"
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" style="width: 600px;">
        <div class="offcanvas-body" data-simplebar>
            ...
            <div class="container">
                <!-- form -->
                <form class="needs-validation" novalidate method="post" action="{{ route('superadmin.storeUser') }}">
                    @csrf
                    <div class="row">
                        <!-- form group -->
                        ...
                        <div class="mb-3 col-12">
                            ...
                            <select id="station" name="station" class="form-select" data-width="100%" required>
                                <option value="">Select Station</option>
                                @foreach ($stations as $station)
                                    <option value="{{ $station->id }}">{{ $station->terminal }}</option>
                                @endforeach
                            </select>
                            <div class="invalid-feedback">Please select assigned station.</div>
                        </div>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="editUser" style="width: 600px;">
        <div class="offcanvas-body" data-simplebar>
            ...
            <div class="container">
                <!-- form -->
                <form class="needs-validation" novalidate method="post" action="{{ route('superadmin.updateUser') }}"
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-12">
                            <label class="form-label">Station <span class="text-danger">*</span></label>
                            <select id="usrstation" name="station" class="form-select" data-width="100%" required>
                                <option value="">Select Station</option>
                                @foreach ($stations as $station)
                                    <option value="{{ $station->id }}">{{ $station->terminal }}</option>
                                @endforeach
