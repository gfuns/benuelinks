                                                                    ...
                                                                    <li>
                                                                        ...
                                                                        @if ($usr->status == 'active')
                                                                            <a class="dropdown-item"
                                                                                ...
                                                                                onclick="return confirm('Are you sure you want to suspend this user account');"><i
                ...
                <div class="container">
                    ...
                    <form class="needs-validation" novalidate method="post" action="{{ route('admin.storeUser') }}">
                        ...
                        <div class="row">
                            ...
                            <input type="hidden" name="station" value="{{ $terminal->id }}" class="form-control"
                                required>
                ...
                <div class="container">
                    ...
                    <form class="needs-validation" novalidate method="post" action="{{ route('admin.updateUser') }}"
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-12">
                                <label class="form-label">Surname <span class="text-danger">*</span></label>
                                <input id="lastname" type="text" name="surname" class="form-control"
