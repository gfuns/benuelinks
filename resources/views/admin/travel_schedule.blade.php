                                                                ...
                                                                @if ($schedule->status == 'in transit' || $schedule->status == 'trip successful')
                                                                    <li>
                                                                        <a class="dropdown-item mb-2"
                                                                            href="{{ route('admin.printPassengerManifest', [$schedule->id]) }}"
                                                                            target="_blank"><i
                                                                                class="fe fe-eye dropdown-item-icon"></i>View
                ...
                <div class="container">
                    ...
                    <form class="needs-validation" novalidate method="post"
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-12">
                                <label class="form-label"><strong>Ticketer</strong> <span
                                        class="text-danger">*</span></label>
                            ...
                            <div class="mb-3 col-12">
                                ...
                                <select id="scheduleConfig" name="schedule_configuration" class="form-select"
                                    ...
                                    <option value="specific" data-configtype="specific">Schedule for a specific date
                                    </option>
                            ...
                            <div id="showDate" class="mb-3 col-12" style="display: none">
                                <label class="form-label"><strong>Scheduled Date</strong> <span
                                        class="text-danger">*</span></label>
                                <input type="date" name="scheduled_date" min="{{ date('Y-m-d') }}"
                                        ...
                                        @foreach ($weekDates as $wd)
                                            <div class="col-md-3 col-3 mb-3">
                                                <div class="input-item input-with-label">
                                                    <input class="gfuns input-checkbox input-checkbox-sm"
                                                        name="week_date[]" id="wd_{{ $loop->index }}"
                                                        value="{{ $wd['date'] }}" type="checkbox">
                                                    <label
                                                        for="wd_{{ $loop->index }}"><strong>{{ $wd['label'] }}</strong>
                                                    </label>
                                                </div>
                                            </div>
                                        @endforeach
        ...
        <div class="modal fade" id="updateTripStatus" tabindex="-1" role="dialog" aria-labelledby="newCatgoryLabel"
            ...
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    ...
                    <form class="needs-validation" novalidate method="post"
                        action="{{ route('admin.updateTripStatus') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="modal-body">
                            <div class="row">
                                <!-- form group -->
