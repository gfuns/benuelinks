        ...
        <div class="col-12 col-md-7 mx-auto">
            ...
            <div class="row m-4">
                <div class="card content-area pt-3 pb-3 ps-4 pe-4 pt-md-5 pb-md-5 ps-md-5 pe-md-5 mb-5">
                    <div class="">
                        <form class="validate-modern" action="{{ route('updatePassengerDetails') }}" method="POST">
                            @csrf
                            <div class="row bg-light inner-card pt-5 pb-5 ps-4 pe-4">
                                <div class="col-12 mb-4">
                                    ...
                                    <div class="input-wrap">
                                        <input class="form-control text-height" type="text" id="last-name" name="last_name"
                                            required="required" placeholder="Enter Last Name" minlength="3"value="" required>
                                    </div>
                                </div>
                                ...
                                <div class="mt-5">
                                    <input id="myid" type="hidden" name="booking_id" value=""
