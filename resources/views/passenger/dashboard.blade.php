                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="view-bills">
                                    <div class="tile-header">
                                        <h6 class="tile-title">Active Employees In This Work Group</h6>
                                    </div>
                                    <div class="tile-data">
                                        <span
                                            class="tile-data-number">A</span>
                    ...
                    <div class="card height-auto">
                        <div class="card-innr">
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="view-bills">
                                    <div class="tile-header">
                                        <h6 class="tile-title">Paygroups In This Work Group</h6>
                                    </div>
                                    <div class="tile-data">
                                        <span
                                            class="tile-data-number">A</span>
                                    ...
                                    <div class="tile-footer">
                                        <div class="tile-link">
                                            <a href=""
                                                class="link link-bold link-ucap ">View PayGroup</a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card-innr">
                           <div class="tab-content">
                                <div class="tab-pane fade show active" id="view-vtpass">
                                    <div class="tile-header">
                                        <h6 class="card-sub-title">Current Salary Month For This Work Group</h6>
                                    </div>
                                    <div class="tile-data">
